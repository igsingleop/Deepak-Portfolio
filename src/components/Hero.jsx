      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-wrap gap-4 mb-8">
            <a
              href="#projects"
              className="px-8 py-3.5 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-outfit font-semibold shadow-lg hover:shadow-cyan-500/30 transition-all flex items-center gap-2 group hover:scale-[1.02] active:scale-[0.98]"
            >
              View My Work
            ...
            <a
              href="#contact"
              className="px-8 py-3.5 rounded-2xl bg-white dark:bg-darkCard text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-800 font-outfit font-semibold hover:bg-slate-100 dark:hover:bg-slate-800 transition-all neo-box-out hover:neo-box-in hover:scale-[1.02] active:scale-[0.98]"
            >
              Contact Me
            </a>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="flex gap-4">
            <a
              ...
              className="w-11 h-11 rounded-2xl flex items-center justify-center neo-btn bg-lightBg dark:bg-darkBg text-slate-600 dark:text-slate-400 hover:text-cyan-500 dark:hover:text-cyan-400 border border-white/20 dark:border-white/5"
