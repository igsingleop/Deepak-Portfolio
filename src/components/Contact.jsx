            ...
            <div className="space-y-4">
              {contactDetails.map((detail, idx) => (
                <a
                  ...
                  className="p-5 rounded-2xl bg-white dark:bg-darkCard border border-white/30 dark:border-white/5 flex items-start gap-4 hover:neo-box-in transition-all duration-300 neo-box-out group"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-5 text-left">
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full py-4 rounded-2xl bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 text-white font-outfit font-bold shadow-lg hover:shadow-cyan-500/20 active:scale-[0.98] transition-all flex items-center justify-center gap-2 group disabled:opacity-75 disabled:pointer-events-none"
                  >
                    {isSubmitting ? (
                      <>
