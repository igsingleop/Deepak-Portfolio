      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7 flex flex-col text-left justify-start">
            ...
            <div className="relative border-l-2 border-emerald-500/30 dark:border-emerald-500/15 ml-2 sm:ml-4 pl-6 sm:pl-8 space-y-8 sm:space-y-10">
              {education.map((item, idx) => (
                ...
                >
                  {/* Timeline dot */}
                  <span className="absolute -left-[40px] sm:-left-[48px] top-1.5 w-8 h-8 rounded-full bg-lightBg dark:bg-darkBg border-2 border-emerald-500 flex items-center justify-center shadow-md shadow-emerald-500/20 group-hover:scale-110 transition-transform">
